...
RESULTS_PATH_RNA <- "~/ELNID001000000000535807/DiffAnalysis/RNA_oneOnOne/"
res <- read_csv("~/ELNID001000000000535807/RNAseq/Diff_analysis/diff.Medium.fatigue_vs_High.fatigue/edgeR_results_allgenes.csv")
