...
rnaseq_diff_results_file <- "~/ELNID001000000000535807/RNAseq/Diff_analysis/diff.Medium.fatigue_vs_High.fatigue/edgeR_results_allgenes.csv"
atacseq_diff_results_file <- "~/ELNID001000000000535807/DiffAnalysis/ATAC/annotatedDifferentialPeaks_noSexChr.csv"
ct_diff_results_file <- "~/ELNID001000000000535807/DiffAnalysis/CUT_TAG/annotatedDifferentialPeaks.csv"
rnaseq_fgsea_results_file <- "~/ELNID001000000000535807/DiffAnalysis/RNA_oneOnOne/enrichedPathwaysHighFatigue.csv"
atacseq_fgsea_results_file <- "~/ELNID001000000000535807/DiffAnalysis/ATAC/enrichedPathwaysHighFatigue_noSexChr.csv"
gene_scatter_file <- "~/ELNID001000000000535807/DiffAnalysis/RNA_oneOnOne//DEGscatterATAC_RNA_CUT_TAGgenes.png"
pathway_scatter_file <- "~/ELNID001000000000535807/DiffAnalysis/RNA_oneOnOne/pathwaysScatterATAC_RNA.png"
pathway_enrichment_point_plot <- "~/ELNID001000000000535807/DiffAnalysis/RNA_oneOnOne/pathwayEnrichment_ATACvsRNA_padj.png"
...
source("/net/beegfs/groups/tytgat/ELNID001000000000486355/DiffAnalysis/scripts/geneTrack.R")  
